...
public class CustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private final int DEFAULT_MINIMUM_HEIGHT = 120;

    private int mMinimumHeight = DEFAULT_MINIMUM_HEIGHT;
    ...
    public CustomBottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        /**
         * Getting the minimum height point...
         */
        a = context.obtainStyledAttributes(attrs, R.styleable.CustomBottomSheetBehavior);

        TypedValue value2 = a.peekValue(R.styleable.CustomBottomSheetBehavior_behavior_minimumHeight);
        if (value2 != null) {
            setmMinimumHeight(a.getDimensionPixelSize(R.styleable.CustomBottomSheetBehavior_behavior_minimumHeight, DEFAULT_MINIMUM_HEIGHT));
        }
        a.recycle();
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        if (mState == STATE_EXPANDED) {
            ...
            ViewCompat.offsetTopAndBottom(child, mParentHeight - mMinimumHeight);
    ...
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, V child, View target) {
        ...
        if (mLastNestedScrollDy > 0) {
            ...
            top = mParentHeight - mMinimumHeight;
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            return MathUtils.clamp(top, mMinOffset, mHideable ? (mParentHeight - mMinimumHeight) : mMaxOffset);
        }
        ...
        public int getViewVerticalDragRange(View child) {
            if (mHideable) {
                return mParentHeight - mMinimumHeight;
            } else {
        ...
        if (bottomSheet != null && mCallback != null) {
            if (top > mMaxOffset) {
                mCallback.onSlide(bottomSheet, (float) (mMaxOffset - top) /
                        (mParentHeight - mMinimumHeight - mMaxOffset));
            } else {
